...
**Cross-cutting services** (basis control, runtime admission, OEM intake, dependency planning, proof handling, fast lane and publication) operate across all dimensions rather than within any single stage. See [CROSS-CUTTING-SERVICES.md](../platform/CROSS-CUTTING-SERVICES.md) for details.
