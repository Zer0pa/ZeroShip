...
<td width="100%" valign="top">
<figure>
        <div><img src="docs/assets/product-page-mechanics.gif" alt="ZeroShip approved scientific square mechanics diagram showing in-silico design-spiral mechanics."></div>
...
<div><b>02 · MARKETS</b> <span>ADJACENT FORECASTS</span></div>
      <div>
        <div>
          <div><span>Maritime decarbonization &mdash; '30</span>  <span>$52.7B</span></div>
          <div><span>Hydrogen generation &mdash; '30</span>  <span>$316.5B</span></div>
          <div><span>Fuel-cell market &mdash; '30</span>  <span>$17.9B</span></div>
          <div><span>Marine engineering software &mdash; '30</span>  <span>$9.8B</span></div>
          <div><span>Green shipping tech &mdash; '31</span>  <span>$79.4B</span></div>
        </div>
      </div>
...
<div><b>05.3 · BENCHMARKS</b> <span>PLATFORM SURFACE</span></div>
      <div>
        ...
        <div>
          ...
          <div><span>V_02 / V_03</span>  <span>PASS</span></div>
          <div><span>V_04</span>  <span>PASS</span></div>
        </div>
      </div>
...
<div><b>06.1 · VERIFICATION RESULTS &middot; V_01–V_04</b></div>
      <div>
        <div>
          <div><span>V_01 README</span>  <span>PASS</span></div>
          <div><span>V_02 anchors</span>  <span>PASS</span></div>
          <div><span>V_03 status packet</span>  <span>PASS</span></div>
          <div><span>V_04 exclusions</span>  <span>PASS</span></div>
        </div>
      </div>
